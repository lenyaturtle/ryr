...
void kursor(int x, int y)//x 565 y 145
{
    ...
    POINT strelka (3) = {{555,125},{555,150},{570,135}};
    txPolygon(strelka, 3);
    txSetColor (TX_WHITE);
    txLine(x,y,570,155);
}
...
txSetFillColor(RGB(255, 255, 255));
txSelectFont ("Arial", 45, 15, FW_BOLD);
txDrawText   (1030, 25, 1125, , "Воин с\n"
                                  "шипами");
}
void voinMechTekst()
{
...
void knopkaSila()
{
    ...
    txSetColor(RGB (163, 73, 164));
    txSetFillColor (RGB (163, 73, 164));//фиолетовый
    POINT minimolnia (11) = {{1040,600},{1052,608},{1048,612},{1060,620},{1057,623},{1075,635},{1067,618},{1070,615},{1059,606},{1063,602},{1055,592}};
    txPolygon(molnia, 11);
}
void knopkaBoss()
{
